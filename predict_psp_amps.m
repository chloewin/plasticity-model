function psp_amps = predict_psp_amps(stim_freq, stim_length, v_0,Ca_0, gain_Ca, loss_Ca, k_recov, ampl_baseline, tau_v, p_relmax);
% Predicts amplitudes of postsynaptic potentials given plasticity related
% parameters assuming a background stimulation of 1Hz.
% Please refer to plasticity_control.m for a walkthrough of the math
% Accepts following parameters
% stim_freq: frequency of high frequency stimulation in Hz
%stim_length: duration of high frequency stimulation
